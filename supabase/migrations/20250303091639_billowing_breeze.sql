...
DROP POLICY IF EXISTS "Restaurant owners can view and manage their restaurants" ON restaurants;
DROP POLICY IF EXISTS "Restaurant members can view restaurants" ON restaurants;
DROP POLICY IF EXISTS "Restaurant owners can manage all members" ON restaurant_members;
DROP POLICY IF EXISTS "Restaurant managers can view all members" ON restaurant_members;
DROP POLICY IF EXISTS "Restaurant managers can add and update members" ON restaurant_members;
DROP POLICY IF EXISTS "Restaurant managers can delete members" ON restaurant_members;
DROP POLICY IF EXISTS "Users can view their own memberships" ON restaurant_members;
