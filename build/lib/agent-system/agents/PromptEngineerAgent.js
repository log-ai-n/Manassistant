...
exports.PromptEngineerAgent = void 0;
const BaseAgent_1 = require("../BaseAgent");
/**
 * Prompt Engineer Agent
 * Responsible for crafting optimal prompts for other agents or external LLMs to use
 */
class PromptEngineerAgent extends BaseAgent_1.BaseAgent {
    constructor(name) {
        super(name, 'prompt-engineer', [
            'craft-prompt',
            'refine-prompt',
            'template-management',
            'prompt-evaluation'
    ...
    initializeDefaultTemplates() {
        this.promptTemplates.set('code-generation', `Create a {language} function that implements the following feature:
      ...
      - Be optimized for readability and maintainability`);
        this.promptTemplates.set('code-review', `Review the following {language} code for issues related to:
      ...
      3. Recommendations for better alternatives if applicable`);
        this.promptTemplates.set('feature-requirements', `Based on the following business requirement:
      {requirement}
    ...
    craftPrompt(task) {
        return __awaiter(this, void 0, void 0, function* () {
            const { templateName, parameters, targetAgent, requirements } = task.context || {};
            ...
            try {
                ...
                // Generate a custom prompt based on requirements
                    ...
                    prompt = yield this.generateCustomPrompt(requirements, targetAgent);
                }
                else {
                ...
                prompt = yield this.enhancePromptWithContext(prompt, task.context);
    ...
    refinePrompt(task) {
        return __awaiter(this, void 0, void 0, function* () {
            const { originalPrompt, feedback, targetAgent } = task.context || {};
    ...
    manageTemplate(task) {
        return __awaiter(this, void 0, void 0, function* () {
            const { action, templateName, templateContent } = task.context || {};
    ...
    evaluatePrompt(task) {
        return __awaiter(this, void 0, void 0, function* () {
            const { prompt, results, criteria } = task.context || {};
            if (!prompt || !results) {
                return this.updateTaskStatus(task, 'failed', {
            ...
            try {
                ...
                return this.updateTaskStatus(task, 'completed', Object.assign(Object.assign({}, evaluation), { overallScore }));
            }
            catch (error) {
    ...
    generateCustomPrompt(requirements, targetAgent) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    enhancePromptWithContext(prompt, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const key of contextKeys) {
                try {
                    const entries = yield this.retrieveKnowledge(String(context[key]));
    ...
    analyzePromptFeedback(feedback) {
    ...
    applyPromptRefinement(prompt, area) {
        switch (area) {
            case 'clarity':
    ...
    scorePrompt(prompt, results, criteria) {
        const scores = {};
    ...
    scoreConstraintCommunication(prompt) {
    ...
    identifyPromptStrengths(prompt) {
        const strengths = [];
        // Clear structure
    ...
    identifyPromptWeaknesses(prompt, results) {
        const weaknesses = [];
        // Check length
    ...
    generatePromptSuggestions(prompt, results) {
        const suggestions = [];
...
exports.PromptEngineerAgent = PromptEngineerAgent;
